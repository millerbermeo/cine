...
<div id="sidebar"
    class="w-[290px] min-w-[200px] h-screen border-r-[1px] border-gray-400 bg-white transform -translate-x-full transition-transform duration-300 sm:translate-x-0">
